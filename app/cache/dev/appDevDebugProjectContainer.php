...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'coherans.form.type.organization' => 'getCoherans_Form_Type_OrganizationService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('bootstrap_css' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/less/bootstrap.less'), 1 => ($this->targetDirs[3].'\\vendor\\braincrafted\\bootstrap-bundle\\Braincrafted\\Bundle\\BootstrapBundle\\DependencyInjection/../Resources/less/form.less'), 2 => ($this->targetDirs[2].'/../vendor/fortawesome/font-awesome/less/font-awesome.less'), 3 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/less/bootstrap.less'), 4 => ($this->targetDirs[2].'/../vendor/braincrafted/bootstrap-bundle/Braincrafted/Bundle/BootstrapBundle/Resources/less/form.less')), 1 => array(0 => 'less', 1 => 'less', 2 => 'cssrewrite'), 2 => array('output' => 'css/bootstrap.css')), 'bootstrap_js' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/transition.js'), 1 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/alert.js'), 2 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/button.js'), 3 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/carousel.js'), 4 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/collapse.js'), 5 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/dropdown.js'), 6 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/modal.js'), 7 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/tooltip.js'), 8 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/popover.js'), 9 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/scrollspy.js'), 10 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/tab.js'), 11 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/affix.js'), 12 => ($this->targetDirs[3].'\\vendor\\braincrafted\\bootstrap-bundle\\Braincrafted\\Bundle\\BootstrapBundle\\DependencyInjection/../Resources/js/bc-bootstrap-collection.js'), 13 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/transition.js'), 14 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/alert.js'), 15 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/button.js'), 16 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/carousel.js'), 17 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/collapse.js'), 18 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/dropdown.js'), 19 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/modal.js'), 20 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/tooltip.js'), 21 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/popover.js'), 22 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/scrollspy.js'), 23 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/tab.js'), 24 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/affix.js'), 25 => ($this->targetDirs[2].'/../vendor/braincrafted/bootstrap-bundle/Braincrafted/Bundle/BootstrapBundle/Resources/js/bc-bootstrap-collection.js')), 1 => array(), 2 => array('output' => 'js/bootstrap.js')), 'jquery' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/jquery/jquery/jquery-1.11.1.js'), 1 => ($this->targetDirs[2].'/../vendor/components/jquery/jquery.min.js')), 1 => array(), 2 => array('output' => 'js/jquery.js')))), 'config');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'CoheransBundle', ($this->targetDirs[2].'/Resources/CoheransBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'CoheransBundle', ($this->targetDirs[3].'\\src\\CoheransBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    /**
     * Gets the 'coherans.form.type.organization' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CoheransBundle\Form\OrganizationType A CoheransBundle\Form\OrganizationType instance.
     */
    protected function getCoherans_Form_Type_OrganizationService()
    {
        return $this->services['coherans.form.type.organization'] = new \CoheransBundle\Form\OrganizationType();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'coherans_test', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\vendor\\gedmo\\doctrine-extensions\\lib\\Gedmo\\Translatable\\Entity'), 1 => ($this->targetDirs[3].'\\vendor\\gedmo\\doctrine-extensions\\lib\\Gedmo\\Loggable\\Entity'), 2 => ($this->targetDirs[3].'\\vendor\\gedmo\\doctrine-extensions\\lib\\Gedmo\\Tree\\Entity'), 3 => ($this->targetDirs[3].'\\src\\CoheransBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Gedmo\\Translatable\\Entity');
        $c->addDriver($b, 'Gedmo\\Loggable\\Entity');
        $c->addDriver($b, 'Gedmo\\Tree\\Entity');
        $c->addDriver($b, 'CoheransBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('Gedmo' => 'Gedmo\\Tree\\Entity', 'CoheransBundle' => 'CoheransBundle\\Entity'));
     ...
     * This method always returns the same instance of the service.
     *
     * @return \CoheransBundle\Listener\DoctrineExtensionListener A CoheransBundle\Listener\DoctrineExtensionListener instance.
     */
    protected function getExtension_ListenerService()
    {
        $this->services['extension.listener'] = $instance = new \CoheransBundle\Listener\DoctrineExtensionListener();
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'BraincraftedBootstrapBundle:Form:bootstrap.html.twig', 1 => 'form_div_layout.html.twig', 2 => 'CoheransBundle:Form:bootstrap-override.html.twig'), 'autoescape' => array(0 => 'Symfony\\Bundle\\TwigBundle\\TwigDefaultEscapingStrategy', 1 => 'guess'), 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'BraincraftedBootstrapBundle:Form:bootstrap.html.twig', 1 => 'form_div_layout.html.twig', 2 => 'CoheransBundle:Form:bootstrap-override.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'CoheransBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\CoheransBundle/Resources/views'), 'Coherans');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c10b808f52f2771041056c445791001b6468');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CoheransBundle' => 'CoheransBundle\\CoheransBundle',
            ...
            'locale' => 'en',
            'secret' => 'c10b808f52f2771041056c445791001b6468',
            ...
            'kernel.secret' => 'c10b808f52f2771041056c445791001b6468',
            ...
            'twig.form.resources' => array(
                0 => 'BraincraftedBootstrapBundle:Form:bootstrap.html.twig',
                1 => 'form_div_layout.html.twig',
                2 => 'CoheransBundle:Form:bootstrap-override.html.twig',
            ),
            ...
            'assetic.filter.less.node_paths' => array(
                0 => 'C:\\Program Files\\nodejs\\node_modules',
                1 => 'C:\\Users\\guilherme\\AppData\\Roaming\\npm\\node_modules',
            ),
